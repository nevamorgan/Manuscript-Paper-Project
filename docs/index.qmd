...
ANOVA Meanings:
Most of the variation in American Bittern observations is explained by year (Fig. 7, F = 14.3678, p = <0.001) and state (Fig. 7, F = 59.0684, p = <0.001), not directly by average temperature (Fig. 8, F = 2.3702, p = 0.1247) or precipitation (Fig. 9, F = 0.1157, p = 0.7340), rejecting our hypothesis and accepting our null hypothesis.
Climate variables (avg. temperature and precipitation) and time of the year has no significant interaction, meaning that the relationship between climate variance and bittern observations appears stable over time within Arizona, California, Oregon, and Washington between 2000 and 2024 (Fig. 10, p = 0.984).
